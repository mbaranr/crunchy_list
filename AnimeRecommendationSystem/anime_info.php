...
<div class="animeinfo-container">
    <?php
    session_start();
    //validating the title to make sure the characters won't damage the sql tables
    ...
    ?>
    <!-- showcasing a big version of the image -->
        <div class="animebig-img">
            <img src="<?php echo $imgpath; ?>" alt="Image" width="600" height="900">
        </div>
        <!-- showing the anime title and making it a hyperlink for the user to go watch it in crunchyroll -->
        <div class="animeinfo-box">
            ...
            <!-- naming the episodes, votes and weight of the anime -->
            ...
            <!-- creating a bar chart or column chart to display the rates per number of stars -->
            <div class="graph">
